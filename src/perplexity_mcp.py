...
MODEL_ALIASES = {
    ...
    "gpt_5_5_thinking": "openai/gpt-5.5-thinking",
...
def list_models():
    ...
    return jsonify({
        "models": [
            {"id": "perplexity/best", "name": "Best", "description": "Perplexity Best (Auto-select)", "tier": "pro", "mode": "search"},
            {"id": "perplexity/deep-research", "name": "Deep Research", "description": "Perplexity Deep Research", "tier": "pro", "mode": "research"},
            {"id": "perplexity/sonar-2", "name": "Sonar 2", "description": "Perplexity Sonar 2", "tier": "pro", "mode": "copilot"},
            {"id": "openai/gpt-5.4", "name": "GPT-5.4", "description": "OpenAI GPT-5.4", "tier": "pro", "mode": "copilot"},
            {"id": "openai/gpt-5.4-thinking", "name": "GPT-5.4 Thinking", "description": "OpenAI GPT-5.4 Thinking", "tier": "pro", "mode": "copilot"},
            {"id": "openai/gpt-5.5-thinking", "name": "GPT-5.5 Thinking", "description": "OpenAI GPT-5.5 Thinking", "tier": "max", "mode": "copilot"},
            {"id": "google/gemini-3.1-pro-thinking-low", "name": "Gemini 3.1 Pro Thinking Low", "description": "Google Gemini 3.1 Pro Thinking Low", "tier": "pro", "mode": "copilot"},
            {"id": "google/gemini-3.1-pro-thinking-high", "name": "Gemini 3.1 Pro Thinking High", "description": "Google Gemini 3.1 Pro Thinking High", "tier": "pro", "mode": "copilot"},
            {"id": "anthropic/claude-sonnet-4.6", "name": "Claude Sonnet 4.6", "description": "Anthropic Claude Sonnet 4.6", "tier": "pro", "mode": "copilot"},
            {"id": "anthropic/claude-sonnet-4.6-thinking", "name": "Claude Sonnet 4.6 Thinking", "description": "Anthropic Claude Sonnet 4.6 Thinking", "tier": "pro", "mode": "copilot"},
            {"id": "anthropic/claude-opus-4.7", "name": "Claude Opus 4.7", "description": "Anthropic Claude Opus 4.7", "tier": "max", "mode": "copilot"},
            {"id": "anthropic/claude-opus-4.7-thinking", "name": "Claude Opus 4.7 Thinking", "description": "Anthropic Claude Opus 4.7 Thinking", "tier": "max", "mode": "copilot"},
            {"id": "moonshot/kimi-k2.6-instant", "name": "Kimi K2.6 Instant", "description": "Moonshot Kimi K2.6 Instant", "tier": "pro", "mode": "copilot"},
            {"id": "moonshot/kimi-k2.6-thinking", "name": "Kimi K2.6 Thinking", "description": "Moonshot Kimi K2.6 Thinking", "tier": "pro", "mode": "copilot"},
